...
## How to implement this in [Pavlovia](https://pavlovia.org/)
I made a website to change the PsychoJS code for you. Check [here](https://run.pavlovia.org/sijiazhao/headphones-check/)!
